...
var numeralHelper = new NumeralHelper();

var text = numeralHelper.Convertir("10000000000", true, true);
...
public class NumeralHelper
{
    ...
    public string Convertir(string numero, bool mayusculas, bool incluirDecimal, string moneda = "PESOS", bool mostrarTipo = false)
    {
        string literal = "";
        ...
        if (mc.Count > 0)
        {
            ...
            parte_decimal = incluirDecimal ? moneda + " " + Num[1] + "/100" + MN : "";
